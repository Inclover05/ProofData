  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen flex flex-col`}>
        <header className="sticky top-0 z-50 bg-glass-surface backdrop-blur-md border-b border-rules">
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            <Link href="/" className="font-semibold text-lg tracking-tight">ProofData</Link>
            <nav className="flex items-center gap-6 text-sm font-medium">
              ...
              <Link href="/warrant/demo" className="text-text-secondary hover:text-text-primary transition-colors">Sample Dossier</Link>
            </nav>
          </div>
        </header>
